...
#
news1 = Post.objects.create(author=Mike_aut, choise='NE', title='Courier', text='Курьер, которого нашли с выстрелом в голову возле'
                                                                      ' Гудспрингс, как сообщается, пришел в сознание и даже'
                                                                      'полностью выздоровел. Курьер на которого действительно'
                                                                      ' можно положиться!')

art1 = Post.objects.create(author=Nick_aut, choise='AR', title='За Республику, часть 2 - Мистер Хаус и Братство Стали и концовка',
